...
import { Loader2, TrendingUp, DollarSign, Calendar, RefreshCw } from 'lucide-react';
...
function DashboardContent() {
  ...
  // Default filters with Parker Tide NAICS/PSC
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {/* Controls - Thinner with loading indicator */}
            <Card>
                ...
                <>
                  {displayedOpportunities.map((opportunity) => (
                    <OpportunityCard
                      ...
                      userId={userId}  // Now using real authenticated user ID
